...
<body>
    ...
    <?php
    include_once("../components/navbar_w_session.php");
    ?>
    ...
    <main>
        ...
        <div class="container mt-5 d-flex justify-content-center">
            ...
            <div class="flex flex-column">
                <div>
                    <h1>Bienvenido <? echo $username ?></h1>
                </div>
                <div>
                    <h1 class="mt-3 mb-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="card mt-5 mx-5" style="width: 28rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../components/agregar_al_carrito.php">

                                        <input type="hidden" name="alojamiento_id" value="<?= $row['alojamiento_id'] ?>">
